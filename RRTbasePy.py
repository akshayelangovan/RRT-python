...
class RRTMap: #contains methods for drawing map, obstacles and path calculated
...
class RRTGraph:
    ...
    def makeobs(self):
        ...
        for i in range(0,self.obsNum):
            rectang=None #hold object temporarily before it gets stored
            startgoalcol = True
            while startgoalcol:
